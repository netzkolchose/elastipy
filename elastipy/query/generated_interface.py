...
class QueryInterface(QueryInterfaceBase):
    ...
    def bool(
            self,
            must: Union[Sequence['QueryInterface'], None] = None,
            must_not: Union[Sequence['QueryInterface'], None] = None,
            should: Union[Sequence['QueryInterface'], None] = None,
            filter: Union[Sequence['QueryInterface'], None] = None,
    ) -> 'QueryInterface':
        """
        ...
        :param must: Union[Sequence['QueryInterface'], None]
            The clause (query) must appear in matching documents and will contribute
            to the score.

        :param must_not: Union[Sequence['QueryInterface'], None]
        ...
        :param should: Union[Sequence['QueryInterface'], None]
            The clause (query) should appear in the matching document.

        :param filter: Union[Sequence['QueryInterface'], None]
    ...
    def match(
            ...
            fuzziness: Union[str, None] = None,
            max_expansions: int = 50,
            prefix_length: int = 0,
            fuzzy_transpositions: bool = True,
            fuzzy_rewrite: Union[str, None] = None,
            lenient: bool = False,
            operator: Union[str, None] = None,
            minimum_should_match: Union[str, None] = None,
        ...
        :param fuzziness: Union[str, None]
        ...
        :param fuzzy_rewrite: Union[str, None]
        ...
        :param minimum_should_match: Union[str, None]
    ...
    def term(
            ...
            value: str,
            boost: Union[float, None] = None,
            case_insensitive: Union[bool, None] = None,
    ) -> 'QueryInterface':
        """
        ...
        :param case_insensitive: Union[bool, None]

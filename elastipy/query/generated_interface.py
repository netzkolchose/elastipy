...
class QueryInterface(QueryInterfaceBase):
    ...
    def bool(
            self,
            must: Sequence['QueryInterface']=None,
            must_not: Sequence['QueryInterface']=None,
            should: Sequence['QueryInterface']=None,
            filter: Sequence['QueryInterface']=None,
    ) -> 'QueryInterface':
        """
        ...
        :param must: Sequence['QueryInterface']
            The clause (query) must appear in matching documents and will contribute
            to the score.

        :param must_not: Sequence['QueryInterface']
        ...
        :param should: Sequence['QueryInterface']
            The clause (query) should appear in the matching document.

        :param filter: Sequence['QueryInterface']

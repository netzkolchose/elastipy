...
class AggregationInterface(AggregationInterfaceBase):
    ...
    def agg_filters(
            self,
            *aggregation_name,
            filters: Dict[str, 'QueryInterface'],
    ) -> 'AggregationInterface':
        """
        ...
        :param filters: Dict[str, 'QueryInterface']

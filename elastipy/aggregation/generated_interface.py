...
class AggregationInterface(AggregationInterfaceBase):
    ...
    def agg_auto_date_histogram(
            ...
            *aggregation_name,
            field: str,
            buckets: int = 10,
            minimum_interval: Union[str, None] = None,
            time_zone: Union[str, None] = None,
            format: Union[str, None] = None,
            keyed: bool = False,
            missing: Union[Any, None] = None,
            script: Union[dict, None] = None,
        ...
        :param minimum_interval: Union[str, None]
        ...
        :param time_zone: Union[str, None]
    ...
    def agg_date_histogram(
            ...
            *aggregation_name,
            field: str,
            calendar_interval: Union[str, None] = None,
            fixed_interval: Union[str, None] = None,
            min_doc_count: int = 1,
        ...
        :param calendar_interval: Union[str, None]
        ...
        :param fixed_interval: Union[str, None]
    ...
    def metric_percentile_ranks(
            ...
            *aggregation_name,
            ...
            values: list,
            keyed: bool = True,
            hdr__number_of_significant_value_digits: Union[int, None] = None,
            missing: Union[Any, None] = None,
            script: Union[dict, None] = None,
    ) -> 'AggregationInterface':
        """
        ...
        :param hdr.number_of_significant_value_digits: Union[int, None]
    ...
    def metric_scripted_metric(
            ...
            *aggregation_name,
            ...
            combine_script: str,
            reduce_script: str,
            init_script: Union[str, None] = None,
        ...
        :param init_script: Union[str, None]

        :param params: Union[dict, None]
    ...
    def metric_t_test(
            ...
            *aggregation_name,
            ...
            b__field: str,
            type: str,
            a__filter: Union[dict, None] = None,
            b__filter: Union[dict, None] = None,
            script: Union[dict, None] = None,
    ) -> 'AggregationInterface':
        """
        ...
        :param a.filter: Union[dict, None]

        :param b.filter: Union[dict, None]
    ...
    def agg_terms(
            ...
            *aggregation_name,
            ...
            show_term_doc_count_error: Union[bool, None] = None,
            order: Union[dict, None] = None,
            min_doc_count: int = 1,
            shard_min_doc_count: Union[int, None] = None,
            missing: Union[Any, None] = None,
            script: Union[dict, None] = None,
    ) -> 'AggregationInterface':
        """
        ...
        :param shard_size: Union[int, None]
        ...
        :param show_term_doc_count_error: Union[bool, None]
        ...
        :param shard_min_doc_count: Union[int, None]
    ...
    def metric_top_hits(
        ...
        :param sort: Union[dict, None]

        :param _source: Union[dict, None]
    ...
    def metric_weighted_avg(
            ...
            *aggregation_name,
            value__field: str,
            weight__field: str,
            value__missing: Union[Any, None] = None,
            weight__missing: Union[Any, None] = None,
            format: Union[str, None] = None,
        ...
        :param value.missing: Union[Any, None]

        :param weight.missing: Union[Any, None]

        :param format: Union[str, None]

        :param value_type: Union[str, None]
